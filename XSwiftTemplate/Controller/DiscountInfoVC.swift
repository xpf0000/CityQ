...
class DiscountInfoVC: XViewController,UIActionSheetDelegate,UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        bottomLine.addObserver(self, forKeyPath: "center", options: .New, context: nil)
    ...
    deinit
    {
        ...
        bottomLine.removeObserver(self, forKeyPath: "center")
