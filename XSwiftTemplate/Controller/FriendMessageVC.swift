...
class FriendMessageVC: UITableViewController {
    ...
    func getMore()
    {
        showMore = true
        httpHandle.reSet()
        httpHandle.url="http://101.201.169.38/api/Public/Found/?service=Quan.getNewsMore&username="+DataCache.Share().userModel.username+"&page=[page]&perNumber=20"
    ...
    override func viewDidLoad() {
        ...
        httpHandle.url="http://101.201.169.38/api/Public/Found/?service=Quan.getNews&username="+DataCache.Share().userModel.username
