...
class XImageUtil: NSObject,NSURLSessionDataDelegate {
    ...
    private override init() {
        ...
        if let raw = "XImageAutoDownType".UserDefaultsValue() as? Int
        {
        ...
        self.whiteBGImage = self.colorToImage(UIColor.whiteColor())
